Feature: To create the Job entry in the test application
  ...
  Scenario: To create the Job Entry with JSON data
    ...
    And request {  "jobId": '#(_id)',"jobTitle": '#(_jobTitle)', "jobDescription": "To develop andriod application", "experience": [ "Google", "Apple", "Mobile Iron", "Google" ], "project": [ { "projectName": "Movie App", "technology": [ "Kotlin", "SQL Lite","Gradle", "Jenkins" ] } ]}
